...
2\.1.4 – All matches must be played on the latest vcod.gg PAM, which can be downloaded at: [**https://www.sendspace.com/file/bzrpfy**](https://www.sendspace.com/file/bzrpfy "https://www.sendspace.com/file/bzrpfy"). Teams can refuse to play on a server if the vcod.gg ruleset has been edited.weekend cup competitions
...
4\.1.5 – The map pool for the competition is: Bocage, Brecourt, Carentan, Dawnville, Depot, German_Town, Harbor, Hurtgen, Neuville, Pavlov, Powcamp, Railyard, Rocket, Stalingrad and Tigertown.
